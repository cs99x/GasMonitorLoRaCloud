...
SemaphoreHandle_t jsonMutex; //needed later i think
...
// readout of Sensors
  ...
  float ppmSensor1 = voltageToPPM(voltage1, sensorSupplyVoltage, 10000, 5000, -0.62, 2.3);
    ...
    doc["battery_pct"] = 84;//dummy
    doc["device_id"] = "99% von euch sind RATTEN!"; // dummy
    doc["timestamp"] = "Sun, 20 Oct 2024 15:30:00 GMT";  // dummy
...
//test if task blocks core0 with blinking LEDs
